...
<tr style="     border-bottom: 1px solid#ddd;
   ...
   <br>
    <button onClick="window.print();">Print Bukti Pembayaran</button> 
    <?php if($status == 0):?>
    <div class="time-left">
    ...
    width: 50%;">
        <strong>Pembayaran melalui..<?php echo $ivd->name_bank;?></strong>
        <br>
        <strong>No.rek : silahkan hubungin admin</strong><?php echo $ivd->acc_bank;?>
        <br>
        <strong>Atas nama : Fatima Eka</strong><?php echo $ivd->owner_bank;?>
    </div>
