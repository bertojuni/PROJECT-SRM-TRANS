...
class Cpublic extends MY_Controller {
	...
	public function p_process_form()
	{
		...
		$config = array('protocol' => 'smtp', 'smtp_host' => 'smtp.gmail.com', 'smtp_port' => '587', 'smtp_user' => 'imma.negro@gmail.com', 'smtp_pass' => 'kilop123',
    	);
		...
		// email content
		$this->email->from('admin@srmtrans.com', $this->web_title());
		$this->email->to($email);
		$this->email->subject('BUKTI PEMESANAN BUS SRMTrans');
